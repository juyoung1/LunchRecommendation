package com.lunch.lunchrecommendation.view.custom
...
class Roulette @JvmOverloads constructor(
    ...
    init {
        ...
        rouletteBorderLineWidth = typedArray.getDimension(
            ...
            RouletteConstant.DEFAULT_CIRCLE_BORDER_LINE_WIDTH
        )
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val rectLeft = (width / 2f) - (shorterLength / 2f) + paddingLeft + RouletteConstant.DEFAULT_PADDING
        val rectRight = (width / 2f) + (shorterLength / 2f) - paddingRight - RouletteConstant.DEFAULT_PADDING
        val rectTop = (height / 2f) - (shorterLength / 2f) + paddingTop + RouletteConstant.DEFAULT_PADDING
        val rectBottom = (height / 2f) + (shorterLength / 2f) - paddingBottom - RouletteConstant. DEFAULT_PADDING
    ...
    private fun drawRoulette(canvas: Canvas, rectF: RectF) {
        ...
        if (rouletteSize in 2..8) {
            ...
            for (i in 0 until rouletteSize) {
                ...
                val y = (centerY + (radius * sin(medianAngle))).toFloat() + RouletteConstant.DEFAULT_PADDING
    ...
    private fun drawTopMarker(canvas: Canvas, rectF: RectF) {
        ...
        val point1 = PointF(centerX - RouletteConstant.DEFAULT_TOP_MARKER_LENGTH, y) // 왼쪽 포인트
        val point2 = PointF(centerX + RouletteConstant.DEFAULT_TOP_MARKER_LENGTH, y) // 오른쪽 포인트
        val point3 = PointF(centerX, rectF.top - 30f + RouletteConstant.DEFAULT_TOP_MARKER_LENGTH) // 아래쪽 포인트
